...
public class BorrowSavingsActivity extends BaseNavigationActivity implements OnCountryPickerListener {
    ...
    protected int getLayoutResID() {
        return R.layout.activity_borrow_savings;
    }
    ...
    private void init() {
        maxAmountTV.setText("(Max Amount: " + Integer.toString(MyApplication.contribution_amount * MyApplication.sUser.my_saving * 3 / 100) + " KES)");
        countryPicker =
        ...
        amountET.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                float a =(float)(amount * (100 + MyApplication.interest_rate)) / 100;
//                repayAmountTV.setText("*Repayment amount will be : " + Integer.toString(amount * (100 + MyApplication.interest_rate) / 100) + " KES");
                repayAmountTV.setText("*Repayment amount will be : " + String.valueOf(Math.ceil(a)) + " KES");
            }
    ...
    @OnClick(R.id.borrowBtn) public void onBorrow() {
        ...
        int maxAmount = MyApplication.contribution_amount * MyApplication.sUser.my_saving * 3 / 100;
        if (amountS.length() == 0) {
        ...
        AndroidNetworking.post(BASE_API_URL + "transactions/addNewPendingTransaction")
                ...
                .addBodyParameter("type", LoanMD.TYPE_3X_MY_SAVING)
