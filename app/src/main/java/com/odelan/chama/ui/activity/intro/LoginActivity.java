...
public class LoginActivity extends BaseActivity implements OnCountryPickerListener {
    ...
    public void login() {
        showLoading();
        String phone = codeET.getText().toString() + phoneET.getText().toString();
        Log.d("Chama_name", chamaNameET.getText().toString());
        Log.d("phone", phone);
        Log.d("password", passwordET.getText().toString());
        Log.d("BASE_API_URL", BASE_API_URL + "users/loginUser");
